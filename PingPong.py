...
def redraw():
    ...
    text = font.render('PONG', False, blanco)
    textRect = text.get_rect()
    textRect.center = (750 // 2, 25)
    ganar.blit(text, textRect)

    # Player 1 Score
    p1_score = font.render(str(paddle1.points), False, blanco)
    p1Rect = p1_score.get_rect()
    p1Rect.center = (50, 50)
    ganar.blit(p1_score, p1Rect)

    # Player 2 Score
    p2_score = font.render(str(paddle2.points), False, blanco)
